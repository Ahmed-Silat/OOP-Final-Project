...
public class DeletePatient extends Application {
...
//                    "JOIN specializations s ON d.specialization_id=s.s_id";
			...
			String query = "SELECT u_id, first_name, last_name, gender, dob, email, password FROM user";
...
//				String specialization = resultSet.getString("specialization");
				...
				tableView.getItems().add(FXCollections.observableArrayList(String.valueOf(doctorId), doctorFirstName,
						doctorLastName, doctorGender, doctorDob, doctorEmail, doctorPassword));
			}
		...
		deleteButton.setOnAction(event -> {
			...
			if (selectedItem != null) {
				...
				Database.deleteRecord("user", primaryKeyColumnName, primaryKeyValue);
